...
.. typealong:: Adding two vector
   ...
   .. tabs::
      ...
      .. tab:: cpu
         ...
         .. literalinclude:: ../examples/OpenACC/HeatEquation/solution/c/HeatEquation/c/heat_equation.c
                                    :language: c

      .. tab:: OpenACC parallel loop

         .. literalinclude:: ../examples/OpenACC/HeatEquation/solution/c/HeatEquation/c/heat_equation_openacc_1.c
                                    :language: c

      .. tab:: OpenACC loop collapse

         .. literalinclude:: ../examples/OpenACC/HeatEquation/solution/c/HeatEquation/c/heat_equation_openacc_2.c
                                    :language: c

      .. tab:: OpenACC data create

         .. literalinclude:: ../examples/OpenACC/HeatEquation/solution/c/HeatEquation/c/heat_equation_openacc_data_1.c
                                                :language: c
