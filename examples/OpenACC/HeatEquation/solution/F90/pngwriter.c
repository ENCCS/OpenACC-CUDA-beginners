...
void cmap(float value, const float scaling, const float maxval,
          pixel_t * pix);
 ...
 * Arguments:
 *   float *data is a pointer to an array of nx*ny values
...
void cmap(float value, const float scaling, const float offset,
          pixel_t * pix)
{
    int ival;
